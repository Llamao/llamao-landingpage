...
function Alert({ children, borderColor, ...props }: BitAlertProps) {
  ...
  return (
    <div className={cn("relative m-1.5", className)}>
      ...
      />
      <div
        className="absolute -top-1.5 w-1/2 right-1.5 h-1.5"
        style={borderColor ? { backgroundColor: borderColor } : undefined}
      />
      <div
        className="absolute -bottom-1.5 w-1/2 left-1.5 h-1.5"
        style={borderColor ? { backgroundColor: borderColor } : undefined}
      />
      <div
        className="absolute -bottom-1.5 w-1/2 right-1.5 h-1.5"
        style={borderColor ? { backgroundColor: borderColor } : undefined}
      />
      <div
